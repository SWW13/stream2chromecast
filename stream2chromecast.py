...
def get_mimetype(filename, ffprobe_cmd=None):
    ...
    if guess is not None:
        if guess.lower().startswith("video/") or guess.lower().startswith("audio/") or guess.lower().startswith(
                "image/"):
            mimetype = guess
    ...
    try:
        ...
        if file_mimetype.startswith("video/") or file_mimetype.startswith("audio/") or file_mimetype.startswith(
                "image/"):
